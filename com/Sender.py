...
def main() -> None:
    ...
    print(f"[Sender] Connected to Receiver {HOST}:{port}")
    ...
    print(f"[Sender]  even: N={short_int(N_even)}, e={e_even}")
    print(f"[Sender]  odd : N={short_int(N_odd)},  e={e_odd}")
    ...
    print("[Sender] EncSeed sent.")

    print("[Sender] Ready to send messages. ('/quit' 입력 시 종료)")
